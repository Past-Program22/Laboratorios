...
// Cuando trabajas con APIs, es importante validar el token de autorización
// para asegurar que solo usuarios autorizados puedan acceder a los recursos.
// Es una manera de encriptar la comunicación y proteger los datos.
// Funciona solo si encuentra el token de autorización en el header HTTP.
...
// Es mi información de conexión a Supabase
...
// Busca la tabla y la devuelve, solo lectura
if ($method === 'GET') {
